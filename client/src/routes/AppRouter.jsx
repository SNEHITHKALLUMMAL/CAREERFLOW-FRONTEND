...
const MentorAssignmentPage = lazy(() =>
  import('@/pages/Dashboard/Placement/MentorAssignmentPage').then((m) => ({
    default: m.MentorAssignmentPage,
  }))
);
const UserManagementPage = lazy(() =>
  import('@/pages/Dashboard/SuperAdmin/UserManagementPage').then((m) => ({
    default: m.UserManagementPage,
  }))
);
const MyTasksPage = lazy(() =>
  import('@/pages/Dashboard/Student/MyTasksPage').then((m) => ({ default: m.MyTasksPage }))
);
const MyAssignedTasksPage = lazy(() =>
  import('@/pages/Dashboard/MyAssignedTasksPage').then((m) => ({ default: m.MyAssignedTasksPage }))
);
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            element: <ProtectedRoute allowedRoles={['student', 'placementOfficer', 'superAdmin']} />,
          ...
          },
          {
            ...
            children: [
              ...
              { path: '/dashboard/tasks', element: <MyTasksPage /> },
            ],
          },
          {
          ...
          {
            element: <ProtectedRoute allowedRoles={['placementOfficer', 'superAdmin']} />,
            children: [
              ...
              { path: '/dashboard/mentor-assignment', element: <MentorAssignmentPage /> },
          ...
          },
          {
            ...
            children: [{ path: '/dashboard/manage-users', element: <UserManagementPage /> }],
          },
          {
            element: <ProtectedRoute allowedRoles={['mentor', 'recruiter', 'superAdmin']} />,
            children: [{ path: '/dashboard/assigned-tasks', element: <MyAssignedTasksPage /> }],
          },
        ],
      },
    ],
